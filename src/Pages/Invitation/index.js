...
const Invitation = () => {
  ...
  async function updateInvi(id) {
    await updateInvitation(id, { etat: "accepté" }).then((response) => {
                  ...
                  {!expiration && (
                    <>
                      <div className="invitation-text">
                        Bonjour {invi.userData.firstName},
                        {invi.creacteBy.firstName} {invi.creacteBy.lastName} (
                        {invi.creacteBy.email}) vous a invité au Hicotech
                      </div>
                      <Button
                        type="primary"
                      ...
                      <Button className="invitation-form-button">
                        Supprimer
                      </Button>
                    </>
                  )}
